...
import com.cloud.whp.common.security.exception.*;
 ...
 */
@Slf4j
public class WhpWebResponseExceptionTranslator implements WebResponseExceptionTranslator {
	...
	private ResponseEntity<OAuth2Exception> handleOAuth2Exception(OAuth2Exception e) {
		...
		return new ResponseEntity<>(new WhpAuth2Exception(e.getMessage()), headers,
			HttpStatus.valueOf(status));
